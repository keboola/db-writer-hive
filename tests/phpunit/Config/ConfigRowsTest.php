...
class ConfigRowsTest extends TestCase
{
    /**
    ...
    {
        $this->checkConfig($config, new HiveConfigRowDefinition());
    ...
    public function invalidConfigProvider(): array
    {
        return [
            ...
            'empty-items' =>  [
                'The path "parameters.items" should have at least 1 element(s) defined.',
                [
                    'data_dir' => '...',     # added by HiveApplication
                    'writer_class' => '...', # added by HiveApplication
                    'db' => [
