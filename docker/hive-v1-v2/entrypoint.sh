...
echo "entrypoint.sh: Starting metastore initialization.";
schematool -dbType postgres -upgradeSchema >/dev/null 2>&1 || schematool -dbType postgres -initSchema
echo "entrypoint.sh: OK. Metastore initialized.";
